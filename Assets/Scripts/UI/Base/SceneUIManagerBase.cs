...
public abstract class SceneUIManagerBase : ViewBase
{
    ...
    public virtual void ShowCanvas(int index)
    {
        ...
        GameManager.Instance.SetGameState((GameStateEnum)index); // ゲームの状態を更新
    ...
    public virtual void PopCanvas()
    {
        ...
        GameManager.Instance.SetGameState((GameStateEnum)previousIndex); // ゲームの状態を更新
        OnAfterCanvasChange?.Invoke(_currentCanvasIndex); // 切り替え後イベント発火
    }
    ...
    public virtual void PopToCanvas(int targetIndex)
    {
        ...
        GameManager.Instance.SetGameState((GameStateEnum)targetIndex); // ゲームの状態を更新
        OnAfterCanvasChange?.Invoke(_currentCanvasIndex); // 切り替え後イベント発火
    }
